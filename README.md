...
Double-click `run_game.bat` to start the game, or run `python main.py` from the command line.

Note: Make sure you have installed the dependencies with `pip install -r requirements.txt` first.
